...
#warning \
    "The log internal thread for log processing can't transfer the log"\
         "well for MCUBoot."
#else
...
#if defined(CONFIG_BOOT_DISABLE_CACHES)
  /* Flush and disable instruction/data caches before chain-loading the
   * application */
